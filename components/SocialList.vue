<template>
  <ul class="socials">
    ...
    <li class="socials__item"><a href="#" class="socials__link">
      ...
      <path d="M32,66.1c-2.6,13.8-5.8,27-15.3,33.9c-2.9-20.8,4.3-36.4,7.7-53c-5.7-9.6,0.7-29.1,12.8-24.3c14.9,5.9-12.9,35.9,5.8,39.6
        c19.5,3.9,27.4-33.8,15.3-46C40.7-1.4,7.4,15.9,11.5,41.2c1,6.2,7.4,8.1,2.6,16.6C2.9,55.4-0.4,46.6,0,34.8
        C0.7,15.6,17.3,2.2,33.9,0.3C54.9-2,74.6,8,77.3,27.8c3.1,22.3-9.5,46.5-31.9,44.7C39.3,72.1,36.8,69,32,66.1z"/>
      </svg>
    </a></li>
    <li class="socials__item"><a href="#" class="socials__link">
      <svg version="1.1" id="All_glyphs" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
         viewBox="0 0 89.6 88" style="enable-background:new 0 0 89.6 88;" xml:space="preserve">
